...
import net.osmand.plus.plugins.motorcyclesensors.MotorcycleSensorsSettingsFragment;
...
public enum SettingsScreenType {
        ...
        MOTORCYCLE_SENSORS_SETTINGS(MotorcycleSensorsSettingsFragment.class.getName(), true, ApplyQueryType.SNACK_BAR, R.xml.motorcycle_sensors_settings, R.layout.profile_preference_toolbar),
