...
//      OBD_FUEL_TYPE("obd_fuel_type", R.string.obd_fuel_type, R.string.obd_fuel_type_desc, R.drawable.widget_weather_temperature_day, R.drawable.widget_weather_temperature_night, 0, VEHICLE_METRICS, RIGHT),
        ...
        MOTORCYCLE_OBD2_RPM("motorcycle_obd2_rpm", R.string.motorcycle_obd2_rpm_widget, R.string.motorcycle_obd2_rpm_widget_desc, R.drawable.widget_motorcycle_gforce_day, R.drawable.widget_motorcycle_gforce_night, 0, MOTORCYCLE_SENSORS, LEFT),
        MOTORCYCLE_OBD2_GEAR("motorcycle_obd2_gear", R.string.motorcycle_obd2_gear_widget, R.string.motorcycle_obd2_gear_widget_desc, R.drawable.widget_motorcycle_lean_angle_day, R.drawable.widget_motorcycle_lean_angle_night, 0, MOTORCYCLE_SENSORS, LEFT),
        MOTORCYCLE_OBD2_TEMP("motorcycle_obd2_temp", R.string.motorcycle_obd2_temp_widget, R.string.motorcycle_obd2_temp_widget_desc, R.drawable.widget_motorcycle_gforce_day, R.drawable.widget_motorcycle_gforce_night, 0, MOTORCYCLE_SENSORS, LEFT),
        MOTORCYCLE_OBD2_THROTTLE("motorcycle_obd2_throttle", R.string.motorcycle_obd2_throttle_widget, R.string.motorcycle_obd2_throttle_widget_desc, R.drawable.widget_motorcycle_gforce_day, R.drawable.widget_motorcycle_gforce_night, 0, MOTORCYCLE_SENSORS, LEFT),
