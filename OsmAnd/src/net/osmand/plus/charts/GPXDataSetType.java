...
import static net.osmand.shared.gpx.PointAttributes.MOTORCYCLE_LEAN_ANGLE;
import static net.osmand.shared.gpx.PointAttributes.MOTORCYCLE_TOTAL_G;
...
public enum GPXDataSetType {
        ...
        MOTORCYCLE_LEAN_ANGLE(R.string.motorcycle_lean_angle_widget, R.drawable.ic_action_motorcycle_dark, MOTORCYCLE_LEAN_ANGLE, R.color.gpx_chart_orange_label, R.color.gpx_chart_orange, GpxDataSetTypeGroup.MOTORCYCLE_SENSORS),
        MOTORCYCLE_TOTAL_G(R.string.motorcycle_gforce_widget, R.drawable.ic_action_motorcycle_dark, MOTORCYCLE_TOTAL_G, R.color.gpx_chart_blue_label, R.color.gpx_chart_blue, GpxDataSetTypeGroup.MOTORCYCLE_SENSORS);
        ...
        public String getMainUnitY(@NonNull OsmandApplication app) {
                ...
                return switch (this) {
                        ...
                        case MOTORCYCLE_LEAN_ANGLE -> "\u00B0";
                        case MOTORCYCLE_TOTAL_G -> "G";
                        default -> "";
                };
        }
}
