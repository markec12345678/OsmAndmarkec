...
class PointAttributes(
        ...
        companion object {
                ...
                // Motorcycle sensor tags
                const val MOTORCYCLE_LEAN_ANGLE = "lean_angle"
                const val MOTORCYCLE_LATERAL_G = "lateral_g"
                const val MOTORCYCLE_LONGITUDINAL_G = "longitudinal_g"
                const val MOTORCYCLE_TOTAL_G = "total_g"
        }
        ...
        private var motorcycleData: MotorcycleData? = null
        ...
        // Motorcycle sensor attributes
        var leanAngle: Float
                get() = motorcycleData?.leanAngle ?: Float.NaN
                set(value) = setMotorcycleValue(value) { leanAngle = it }

        var lateralG: Float
                get() = motorcycleData?.lateralG ?: Float.NaN
                set(value) = setMotorcycleValue(value) { lateralG = it }

        var longitudinalG: Float
                get() = motorcycleData?.longitudinalG ?: Float.NaN
                set(value) = setMotorcycleValue(value) { longitudinalG = it }

        var totalG: Float
                get() = motorcycleData?.totalG ?: Float.NaN
                set(value) = setMotorcycleValue(value) { totalG = it }

        fun hasAnyValueSet(): Boolean = !speed.isNaN() || !elevation.isNaN() ||
                        hasAnySensorValueSet() || hasAnyDevValueSet() || hasAnyVehicleValueSet() || hasAnyMotorcycleValueSet()
        ...
        fun hasAnyMotorcycleValueSet(): Boolean = motorcycleData?.hasAnyValueSet() == true
        ...
        fun getAttributeValue(tag: String): Float =
                when (tag) {
                        ...
                        MOTORCYCLE_LEAN_ANGLE -> leanAngle
                        MOTORCYCLE_LATERAL_G -> lateralG
                        MOTORCYCLE_LONGITUDINAL_G -> longitudinalG
                        MOTORCYCLE_TOTAL_G -> totalG
        ...
        fun setAttributeValue(tag: String, value: Float) {
                when (tag) {
                        ...
                        MOTORCYCLE_LEAN_ANGLE -> leanAngle = value
                        MOTORCYCLE_LATERAL_G -> lateralG = value
                        MOTORCYCLE_LONGITUDINAL_G -> longitudinalG = value
                        MOTORCYCLE_TOTAL_G -> totalG = value
                }
        }
        ...
        fun hasValidValue(tag: String): Boolean {
                ...
                return when (tag) {
                        ...
                        POINT_ELEVATION,
                        MOTORCYCLE_LEAN_ANGLE -> !value.isNaN()

                        MOTORCYCLE_LATERAL_G,
                        MOTORCYCLE_LONGITUDINAL_G,
                        MOTORCYCLE_TOTAL_G -> !value.isNaN()
        ...
        private fun ensureMotorcycleData() = motorcycleData ?: MotorcycleData().also { motorcycleData = it }
        ...
        private inline fun setMotorcycleValue(value: Float, setter: MotorcycleData.(Float) -> Unit) {
                val data = motorcycleData
                if (!value.isNaN() || data != null) {
                        (data ?: ensureMotorcycleData()).setter(value)
                }
        }
        ...
        private class MotorcycleData {
                var leanAngle: Float = Float.NaN
                var lateralG: Float = Float.NaN
                var longitudinalG: Float = Float.NaN
                var totalG: Float = Float.NaN
