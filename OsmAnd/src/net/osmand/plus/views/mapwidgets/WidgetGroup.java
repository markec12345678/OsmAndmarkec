...
public enum WidgetGroup {
        ...
        MOTORCYCLE_SENSORS(R.string.motorcycle_sensors_widget_group, 0, R.drawable.ic_action_motorcycle_dark, R.drawable.ic_action_motorcycle_dark, 0),
        ...
        public String getSecondaryDescription(@NonNull Context context) {
                ...
                } else if (this == MOTORCYCLE_SENSORS) {
                        return getPartOfPluginDesc(context, MotorcycleSensorsPlugin.class);
                }
                return null;
        }
        ...
        public int getSecondaryIconId() {
                if (this == BEARING || this == COORDINATES_WIDGET) {
                        return R.drawable.ic_action_help;
                                ...
                                || this == WEATHER || this == ANT_PLUS || this == MOTORCYCLE_SENSORS) {
